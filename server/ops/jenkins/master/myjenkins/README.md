# Jenkins Helm Chart
## Added Docker support for jenkins-master (using external docker.sock)
(cloned from official repository: https://github.com/helm/charts/tree/master/stable/jenkins)
